...
function drawCarTopDown(x, y, w, h, bodyColor) {
  ...
  ctx.beginPath();
  ctx.ellipse(x + w / 2, y + h * 0.92, w * 0.46, h * 0.16, 0, 0, Math.PI * 2);
  ctx.fillStyle = "rgba(0,0,0,0.30)";
  ctx.fill();
  ctx.globalAlpha = 1;

  // body (slightly tapered, less boxy)
  const sTop = w * 0.18;
  const sMid = w * 0.06;
  const sBot = w * 0.14;
  const yTop = y + h * 0.10;
  ...
  ctx.beginPath();
  ctx.moveTo(x + sTop, yTop);
  ctx.quadraticCurveTo(x + w * 0.50, y, x + w - sTop, yTop);
  ctx.quadraticCurveTo(x + w, y + h * 0.20, x + w - sMid, yA);
  ctx.lineTo(x + w - sMid, yB);
  ctx.quadraticCurveTo(x + w, y + h * 0.82, x + w - sBot, yBot);
  ctx.quadraticCurveTo(x + w * 0.50, y + h, x + sBot, yBot);
  ctx.quadraticCurveTo(x, y + h * 0.82, x + sMid, yB);
  ctx.lineTo(x + sMid, yA);
  ctx.quadraticCurveTo(x, y + h * 0.20, x + sTop, yTop);
  ctx.closePath();
  ctx.fill();

  // subtle outline
  ctx.strokeStyle = "rgba(255,255,255,0.10)";
  ctx.lineWidth = Math.max(1.1, w * 0.03);
  ctx.stroke();

  // gentle shading to add depth (no center stripe)
  const shade = ctx.createLinearGradient(x, y, x, y + h);
  shade.addColorStop(0, "rgba(255,255,255,0.10)");
  shade.addColorStop(0.30, "rgba(0,0,0,0.06)");
  ...
  // windows (top-down car look)
  ctx.fillStyle = "rgba(8,18,28,0.48)";
  drawRoundedRect(x + w * 0.24, y + h * 0.18, w * 0.52, h * 0.26, w * 0.18);
  ctx.fill();
  drawRoundedRect(x + w * 0.28, y + h * 0.54, w * 0.44, h * 0.18, w * 0.16);
  ctx.fill();

  // window highlights
  ctx.fillStyle = "rgba(255,255,255,0.12)";
  drawRoundedRect(x + w * 0.30, y + h * 0.22, w * 0.40, h * 0.08, w * 0.12);
  ctx.fill();
  drawRoundedRect(x + w * 0.32, y + h * 0.58, w * 0.34, h * 0.06, w * 0.10);
  ctx.fill();

  // side mirrors
  ctx.fillStyle = "rgba(0,0,0,0.25)";
  drawRoundedRect(x + w * 0.02, y + h * 0.32, w * 0.12, h * 0.10, w * 0.06);
  ctx.fill();
  drawRoundedRect(x + w * 0.86, y + h * 0.32, w * 0.12, h * 0.10, w * 0.06);
  ctx.fill();

  // wheels
  ctx.fillStyle = "rgba(0,0,0,0.62)";
  const ww = Math.max(4, w * 0.18);
  const wh = Math.max(10, h * 0.18);
  const wy1 = y + h * 0.24;
  const wy2 = y + h * 0.62;
  drawRoundedRect(x - ww * 0.20, wy1, ww, wh, ww * 0.45);
  drawRoundedRect(x + w - ww * 0.80, wy1, ww, wh, ww * 0.45);
  drawRoundedRect(x - ww * 0.20, wy2, ww, wh, ww * 0.45);
  drawRoundedRect(x + w - ww * 0.80, wy2, ww, wh, ww * 0.45);
  ctx.fill();

  // lights (front bottom + tiny rear)
  ctx.fillStyle = "rgba(255,255,255,0.78)";
  ctx.beginPath();
  ctx.arc(x + w * 0.26, y + h * 0.90, Math.max(2.2, w * 0.055), 0, Math.PI * 2);
  ctx.arc(x + w * 0.74, y + h * 0.90, Math.max(2.2, w * 0.055), 0, Math.PI * 2);
  ctx.fill();

  ctx.fillStyle = "rgba(255,70,90,0.55)";
  ctx.beginPath();
  ctx.arc(x + w * 0.26, y + h * 0.12, Math.max(2.0, w * 0.045), 0, Math.PI * 2);
  ctx.arc(x + w * 0.74, y + h * 0.12, Math.max(2.0, w * 0.045), 0, Math.PI * 2);
  ctx.fill();
...
function drawPlayerCarPremium(x, y, w, h) {
  ...
  paint.addColorStop(0, "rgba(150,235,255,0.98)");
  ...
  // windows
  ctx.fillStyle = "rgba(8,18,28,0.46)";
  drawRoundedRect(x + w * 0.24, y + h * 0.18, w * 0.52, h * 0.26, w * 0.18);
  ctx.fill();
  drawRoundedRect(x + w * 0.28, y + h * 0.54, w * 0.44, h * 0.18, w * 0.16);
  ctx.fill();
  ...
  ctx.beginPath();
  ctx.arc(x + w * 0.26, y + h * 0.90, Math.max(2.6, w * 0.06), 0, Math.PI * 2);
  ctx.arc(x + w * 0.74, y + h * 0.90, Math.max(2.6, w * 0.06), 0, Math.PI * 2);
  ctx.fill();

  // tiny rear lights
  ctx.fillStyle = "rgba(255,70,90,0.45)";
  ctx.beginPath();
  ctx.arc(x + w * 0.26, y + h * 0.12, Math.max(2.2, w * 0.05), 0, Math.PI * 2);
  ctx.arc(x + w * 0.74, y + h * 0.12, Math.max(2.2, w * 0.05), 0, Math.PI * 2);
  ctx.fill();
