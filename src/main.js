...
async function updateShareCounterUI() {
  ...
  if (btn) {
    // Only disable when we *know* the limit is reached.
    btn.disabled = !lastLeaderboardData || used >= SHARE_DAILY_LIMIT;
  }
}
  ...
  openSheet(
    ...
    <div class="btnRow" style="margin-top:12px">
      ...
      <div class="pillStack" id="sharePillStack">
        <button class="pill pillShare" id="shareStatsBtn" disabled>Share your stat</button>
