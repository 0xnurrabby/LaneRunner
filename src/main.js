...
// Background music (loops during gameplay; starts after first user gesture)
...
async function trySdkHaptic(kind) {
  try {
    const fn = sdk?.actions?.hapticImpact;
...
// Canvas tap: unlock audio/haptics; if game over, restart.
